...
def main():
    ...
    mcd.read_uml_from_file('file_upload.plantuml', edge_style=style1, label_style=label_style)
    ...
    mcd.read_uml_from_file('process.plantuml', edge_style=style2, label_style=label_style)

    result_file = f'../output/output.{prefix}_plantuml.end2end.drawio'
