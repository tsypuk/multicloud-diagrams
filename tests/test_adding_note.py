...
class TestMCDConnections(TestUtilities):
    ...
    def test_note(self):
        ...
        expected_label = {
            ...
            'value': 'Action1, Action2<BR>Additional Note added to existing '
                     'EDGE<BR>Second Note added to existing EDGE<BR>Third Note '
                     'added to existing EDGE',
            'vertex': '1'}
        ...
        # mcd.dump()
        mcd.export_to_file('docs/docs/core-components/output/drawio/note.drawio')
