...
class TestMultiCloudDiagramsDefaultDrawIO(TestUtilities):
    ...
    def test_comment(self):
        ...
        # when
        mcd.add_vertex(node_id="test_arn", node_name=resource_name, metadata={}, node_type=resource_type)

        # then
        expected = {
            'id': 'vertex:test:test_arn',
            'value': '<b>Name</b>: test_name<BR><b>ID</b>: test_arn',
    ...
    def test_add_vertex_no_metadata(self):
        ...
        # when
        mcd.add_vertex(node_id="test_arn", node_name=resource_name, node_type=resource_type)
    ...
    def test_add_vertex_no_arn(self):
        ...
        expected = {
            ...
            'value': '<b>Name</b>: test_name<BR><b>ID</b>: 123',
            'vertex': '1'
        }
        self.verify_resource(expected, mcd.mx_file, resource_name, 'fallback_vertex', debug_mode=False)
