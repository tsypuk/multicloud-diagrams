...
class TestAWSVertexInIsolation(TestRendering):
    ...
    def test_dynamo(self):
        ...
        metadata = {
            'client-vpn endpoint': 'ARN: aws:clientvpn:us-west-1:prod/cvpn-endpoint-0e3b',
            'SplitTunnel': False,
            'DNSServer': '8.8.8.8',
            'VPNProtocol': 'openVPN',
            'Transport': 'UDP',
        ...
        expected = {'id': 'vertex:client_vpn:aws:clientvpn:us-west-1:prod/cvpn-endpoint-0e3b',
                    ...
                    'value': '<b>Name</b>: vpc-client-vpn<BR><b>ARN</b>: '
                             'aws:clientvpn:us-west-1:prod/cvpn-endpoint-0e3b<BR>-----------<BR><b>client-vpn '
                             'endpoint</b>: ARN: '
                             'aws:clientvpn:us-west-1:prod/cvpn-endpoint-0e3b<BR><b>SplitTunnel</b>: '
