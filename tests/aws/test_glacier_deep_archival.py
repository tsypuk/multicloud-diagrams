...
class TestAWSVertexInIsolation(TestRendering):
    ...
    def test_glacier(self):
        # docs
        self.node_type = 'glacier_deep_archival'
        ...
        mcd.add_vertex(node_id=glacier_arn, node_name='content_bucket', node_type='glacier_deep_archival', metadata=metadata)

        # then
        expected = {'id': 'vertex:glacier_deep_archival:arn:aws:glacier:::content_bucket',
                    'parent': '1',
        ...
        self.verify_resource(expected, mcd.mx_file, 'content_bucket', 'glacier_deep_archival')
