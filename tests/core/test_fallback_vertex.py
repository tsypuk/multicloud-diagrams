...
class TestCoreVertexInIsolation(TestRendering):
    ...
    def test_fallback_vertex(self):
        ...
        mcd.add_vertex(node_id=arn, node_name='non_existing_super_cloud_service', arn=arn, node_type='non_existing_super_cloud_service', metadata=metadata)
        ...
        expected = {
            ...
            'value': '<b>Name</b>: non_existing_super_cloud_service<BR><b>ARN</b>: '
